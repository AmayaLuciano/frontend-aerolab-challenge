...
const MWalkthrough = (props: Props) => {
  return (
    <div className=" lg:hidden flex-col  overflow-visible">
      ...
      <div className=" bg-gradient-to-r from-[rgba(23,111,235,0.5)] to-[rgba(255,128,255,0.5)] -mt-[360px] pt-[350px] h-[1709px]">
        <div className="mt-[10px]  p-3 rounded-[32px] w-[335px] h-[408px]  bg-white/60  mx-auto">
